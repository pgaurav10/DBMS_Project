# -*- coding: utf-8 -*-
"""
Created on Fri Sep 29 11:38:08 2017
...
def connect():
    ...
    cur=conn.cursor()
    cur.execute("CREATE TABLE IF NOT EXISTS book_p (id INTEGER PRIMARY KEY, title text, author text, quantity text, price text)")
    conn.commit()
    conn.close()
